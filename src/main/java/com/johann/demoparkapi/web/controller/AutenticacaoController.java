...
import com.johann.demoparkapi.jwt.JwtToken;
import com.johann.demoparkapi.jwt.JwtUserDetailsService;
import com.johann.demoparkapi.web.dto.UsuarioLoginDto;
...
@Tag(name = "Autenticação", description = "Recurso para prosseguir com a autenticação da API.")
@Slf4j
...
public class AutenticacaoController {
    ...
    @Operation(
            ...
            description = "Recurso para autenticação na API.",
            responses = {
