...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComUsernameInvalido_RetornarRetornarErrorMessageStatus422(){
    ...
    @Test
    public void createUsuario_ComPasswordInvalido_RetornarRetornarErrorMessageStatus422(){
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@gmail.com", "12345asd6"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
